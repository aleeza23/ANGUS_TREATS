                ...
                <div className="flex flex-wrap mx-auto">
                    <div className="w-full  lg:w-7/12 px-4 mb-10 lg:mb-0">
                        <div className="md:ml-8 text-white">
                            ...
                            <p className="mb-4">
                                At Angus treats every dish is crafted with care, and every flavor tells a story. From the rich, smoky taste of our expertly grilled steaks to the vibrant, fresh ingredients in our salads, each bite is a journey through culinary excellence.
                            </p>
                            <p className="mb-4">
